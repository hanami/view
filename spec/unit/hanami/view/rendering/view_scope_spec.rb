RSpec.describe Hanami::View::Rendering::ViewScope do
  describe '#respond_to?' do
    describe 'when the view implements the method' do
      it 'returns true' do
        scope = Hanami::View::Rendering::ViewScope.new(ViewForScopeTest.new)
    ...
    describe 'when the scope implements the method' do
      it 'returns true' do
        scope = Hanami::View::Rendering::ViewScope.new(ViewForScopeTest.new, {x: 23})
  ...
  describe '#class' do
    it 'returns proper class name' do
      scope = Hanami::View::Rendering::ViewScope.new(ViewForScopeTest.new)
      expect(scope.class).to eq Hanami::View::Rendering::ViewScope
    end
  end
